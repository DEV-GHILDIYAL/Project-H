...
public class Chicken : MonoBehaviour
{
    ...
    public void SpawnDeadChicken()
    {
        if(gameObject.tag == "NormalChicken")
        {
            Instantiate(gameManager.deadNormalChicken, gameObject.transform.position, Quaternion.Euler(0, 0, 90));
        }
        else if(gameObject.tag == "CursedChicken")
        {
            Instantiate(gameManager.deadCursedChicken, gameObject.transform.position, Quaternion.Euler(0,0,90));
        }
    }
